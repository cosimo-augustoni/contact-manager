...
namespace contact_manager.Presenters.Employees
{
    public class EmployeeDetailPresenter : EmployeeDetailPresenterBase<Employee, IEmployeeDetailDialog>
    {
        ...
        public EmployeeDetailPresenter(IEmployeeDetailDialog dialog, IEmployeeService<Employee> employeeService, User user, bool isNewMode, IHistoryService historyService) 
            : base(dialog, employeeService, user, isNewMode, historyService)
        {
        }
