...
namespace contact_manager.Views.Validation
{
    internal class EmployeeValidator
    {
        ...
        private readonly EmployeeDetailDialog _dialog;

        public EmployeeValidator(ErrorProvider errorProvider, EmployeeDetailDialog employeeDetailDialog)
        {
            this._errorProvider = errorProvider;
            this._dialog = employeeDetailDialog;
        }
